...
public class EmployeeFormAdmin extends JPanel {
    ...
    public void initComponents() {
        ...
        btnUpdate.setIcon(new ImageIcon(EmployeeFormAdmin.class.getResource("/images/edit-icon.png")));
        ...
        btnAdd.setIcon(new ImageIcon(EmployeeFormAdmin.class.getResource("/images/add-user 24.png")));
        ...
        btnExportExcel.setIcon(new ImageIcon(EmployeeFormAdmin.class.getResource("/images/excel.png")));
        ...
        btnFilter.setIcon(new ImageIcon(EmployeeFormAdmin.class.getResource("/images/search-icon.png")));
